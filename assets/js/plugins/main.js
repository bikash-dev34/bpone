...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    $("#menu-item-22").find("a").attr("data-animation", "59");
    $("#menu-item-22").find("a").attr("data-goto", "2");
    $("#menu-item-23").find("a").attr("data-animation", "60");
    $("#menu-item-23").find("a").attr("data-goto", "3");
    $("#menu-item-24").find("a").attr("data-animation", "61");
    $("#menu-item-24").find("a").attr("data-goto", "4");
    $("#menu-item-21").find("a").attr("data-animation", "58");
    $("#menu-item-21").find("a").attr("data-goto", "5");
    $("#menu-item-25").find("a").attr("data-animation", "59");
    $("#menu-item-25").find("a").attr("data-goto", "6");
  });
})(jQuery);
